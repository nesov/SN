...
public class Check_Server_Rendering_MOB_WEB_Test_Suite {
    ...
    private ISettings settings,settings1;
...
//    };
    ...
    public void setUp() {
        ...
        settings1 = new ChromeSettings();
        settings1.setUp(BrowserType.WEB);
    ...
    void checking_rendering_on_important_instances(){
        Utils.passThroughAllTheIntances(IMPORTANT_INSTANCES,settings1);
    }
}
